      ...
      <div className="space-y-4">
        ...
        <div className="w-full">
          ...
          <select
            ...
            disabled={isCreating}
            className="w-full px-3 py-2 text-base rounded-md border border-gray-300 bg-white text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 focus:outline-none transition-colors duration-200"
          >
